...
Задачи: позиция самой правой тройки, максимальное пересечение отрезков, алгоритм Эратосфена.
...
Не включаю в расчёт кратные 4, 6, 8, 9 и тд числа, можно добиться более точной оценки - O(N * loglogN)
